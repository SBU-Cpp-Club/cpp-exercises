int main() {
  ...
  const int *p1 = &i2; // legal, p1 will always point to i2, and we can modify i2 through p1

  // const int &const r2; // illegal, needs to be initialized, references are always 'const' in a sense

  const int ii2 = i, &rr = i;  // legal, we will not be able to modify i through r though
